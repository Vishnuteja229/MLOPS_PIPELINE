...
def save_data(train_data : pd.DataFrame,test_data : pd.DataFrame,data_path:str)->None:
    try:
        ...
        train_data.to_csv(os.path.join(raw_data_path,'tarin.csv'))
...
def main():
    try:
        ...
        data_path = 'C:/Users/vishn.000/PYTHON CODES/DATA_SCIENCE/MLOPS/MY_CODES/MLOPS_PIPELINE/experiments/spam.csv'
